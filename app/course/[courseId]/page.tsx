...
import ChatInput, { ChatProps } from "@/components/chat/chat";
...
export default function Page({ params }: { params: Promise<{ courseId: string }> }) {
  ...
  return (
    <div
      className={cn(
        `w-full h-full max-h-full flex justify-between`,
                ...
                <div className="flex flex-col gap-6 justify-between max-w-3xl">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[16px] font-[400] leading-5">
                      This video you will learn that the how cells are the basic building
                      blocks of life. All living organisms are composed of one or more
                      cells, which carry out vital functions necessary for survival.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-row gap-3">
                    ...
                    <div className="flex flex-col gap-0.5 justify-center">
                      ...
                      <p className="text-[12px] font-[400] line-clamp-2">
                        ...
                        building blocks of life. All living organisms are composed of one
                        or more cells, which carry out vital functions necessary for
                        survival.
                      </p>
                    </div>
                  </div>
